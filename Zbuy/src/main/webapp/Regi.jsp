	...
	<div>
		<form action="RegiConfirm.jsp">
			<table border="1">
				<tr>
					<th>구매번호(자동발생)</th>
					<td style="text-align: left;"><input type="text" readonly name="sale_no" value="0010"></td>
				</tr>
				
				<tr>
					<th>구매일자(자동발생)</th>
					<td style="text-align: left;"><input type="text" readonly name="sale_ymd" value="20240402"></td>
				</tr>
				...
				<tr>
					<th>구매수량</th>
					<td style="text-align: left;"><input type="text" name="sale_cnt"></td>
				</tr>		
